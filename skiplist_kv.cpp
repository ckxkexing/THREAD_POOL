...
private:
    struct skip_list_node {
        ...
        skip_list_node(K k, V v, int l, skip_list_node *nxt = nullptr) :
...
public:
    ...
    skip_list() :
        head(new node()), tail(new node()), less{Comp()} {
        init();
    }
    skip_list(Comp _less) :
        head(new node()), tail(new node()), less{_less} {
        init();
    }
